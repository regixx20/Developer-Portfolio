const experiences = [
  {
    ...
    description:
      "Au cours de mon année en tant que développeur back-end Python chez Gatewatcher, une entreprise de cybersécurité à Paris, La Défense, j'ai pu participer au développement de solutions de remédiation à des incidents de cybersécurité en utilisation des IA agentiques. Mes missions principales organisées en SCRUM incluaient :",
    achievements: [
  ...
  },
  {
    ...
    description:
      "Lors de mon stage de fin d'études chez SEMWEE, une startup spécialisée dans l'automatisation de la recherche de marché et l'optimisation du trafic web à Paris. Mes missions principales incluaient :",
    achievements: [
